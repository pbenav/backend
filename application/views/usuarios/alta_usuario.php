            ...
            <div class="col-12">
                ...
                <div class="card mb-3">
                    <div class="card-header">                       
                        <i class="fa fa-table"></i> Nuevo usuario</div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <form name="alta_usuario" action="<?php echo base_url(); ?>usuarios/guardar" method="POST">                                                                
                                <fieldset>
                                    <div class="row grid-divider">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control col-8" type="text" name="username" id="username" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="password" class="control-label">Contraseña</label>
                                                    <input class="form-control col-8" type="password" name="password" id="password" required="" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-control">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="codigo_usuario" id="codigo_usuario">
                                                </div>
                                                <div class="form-group">
                                                    <label for="parent_usuario" class="control-label">Depende de</label>
                                                    <div class="">
                                                        <input class="form-control" type="text" name="parent_usuario" id="parent_usuario">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <button type="submit" class="btn btn-primary btn">Añadir</button>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
